<p align="center">
  <img src="https://komarev.com/ghpvc/?username=Axlfc&label=Profile%20views&color=0e75b6&style=flat" alt="Profile views" />
</p>
...
> **He analitzat 84 eines de software. El meu nivell ètic corporatiu és: ⭐⭐⭐ (3.1/5)**

<div align="center">

[![Registre Complet](https://img.shields.io/badge/📊_Veure_Anàlisi_Complet-4CAF50?style=for-the-badge&logo=chartdotjs&logoColor=white)](https://usuaris.tinet.cat/~axlfc/)

</div>

### 📊 Distribució del meu Stack

```
🟢 Software Lliure/Ètic (⭐⭐⭐⭐⭐): 35 eines (41.7%)
🟡 Propietari amb Bones Pràctiques (⭐⭐⭐): 28 eines (33.3%)
🟠 Corporatiu Mixt (⭐⭐): 15 eines (17.9%)
🔴 Problemàtic (⭐): 6 eines (7.1%)
```
...
<td width="33%" align="center">
  <img src="https://img.shields.io/badge/🌍-Sostenibilitat-2E7D32?style=for-the-badge" alt="Sostenibilitat" />
  <br><br>
  <b>Codi Eficient</b><br>
  Optimització de recursos<br>
  Infraestructura responsable<br>
  <sub>Low-power computing</sub>
</td>
<td width="33%" align="center">
  <img src="https://img.shields.io/badge/🤝-Inclusivitat-1976D2?style=for-the-badge" alt="Inclusivitat" />
  <br><br>
  <b>Accessibilitat Universal</b><br>
  Disseny per a tothom<br>
  Open Source per defecte<br>
  <sub>FLOSS advocate</sub>
</td>
<td width="33%" align="center">
  <img src="https://img.shields.io/badge/🔒-Privacitat-C62828?style=for-the-badge" alt="Privacitat" />
  <br><br>
  <b>Data Ethics</b><br>
  Zero tracking quan sigui possible<br>
  Transparència total<br>
  <sub>Privacy by design</sub>
</td>
</tr>
</table>
...
| Causa | Compromís | Eines Usades |
|-------|-----------|--------------|
| 🌿 **Tecnologia Sostenible** | Reducció de petjada de carboni | Raspberry Pi, ESP32, Proxmox |
| 🎮 **Gaming Accessible** | Videojocs per a totes les persones | Godot Engine, Blender |
| 🧠 **IA Ètica** | Intel·ligència Artificial responsable | Ollama, Hugging Face, Mistral AI |
| 📚 **Educació Oberta** | Coneixement lliure i compartit | Jupyter, Python, GNU Project |
| 🌐 **Internet Lliure** | Privacitat i neutralitat de la xarxa | Pi-hole, Signal, Matrix/Element |
| 🔓 **Software Lliure** | FLOSS first, propietari només si cal | Linux, FSF, Apache, Mozilla |

</div>

---

## 🛠️ Tech Stack (Categoritzat per Nivell Ètic)

### 🟢 Software Lliure i Ètic (⭐⭐⭐⭐⭐)

<div align="center">

**Fundacions i Projectes de Referència**
<table>
<tr>
...
```
❌ Meta/Facebook/WhatsApp     → Problemes de privacitat massiva
❌ TikTok/ByteDance            → Concerns de seguretat nacional
❌ Twitter/X                   → Deriva antidemocràtica
❌ Google (serveis principals) → Monopoli de dades
❌ Microsoft Windows           → Preferència Linux
❌ Kaspersky                   → Problemes geopolítics
```
...
## 💻 Competències Tècniques per Categoria
...
<tr>
  <td width="50%">
    <b>Engines (Preferència FOSS)</b>
    <ul>
      <li>🟢 Godot Engine ⭐⭐⭐⭐⭐</li>
      <li>🟢 Blender (3D/Assets) ⭐⭐⭐⭐⭐</li>
      <li>🟠 Unity ⭐⭐⭐⭐</li>
      <li>🟠 Unreal Engine ⭐⭐⭐</li>
    </ul>
  </td>
...
### 🌐 Web Development (Stack Ètic)

<table>
<tr>
  <td><b>Frontend</b></td>
  <td>React 🟡, HTML/CSS 🟢, TypeScript 🟢</td>
</tr>
<tr>
  <td><b>Backend</b></td>
  <td>Python/Django 🟢, FastAPI 🟢, Node.js 🟢</td>
</tr>
<tr>
  <td><b>Database</b></td>
  <td>PostgreSQL 🟢, Supabase 🟡, MongoDB 🟡</td>
</tr>
<tr>
  <td><b>DevOps</b></td>
  <td>Docker 🟢, Git 🟢, Nginx 🟢, Proxmox 🟢</td>
</tr>
<tr>
  <td><b>Cloud/Hosting</b></td>
  <td>Cloudflare 🟡, Self-hosted 🟢</td>
</tr>
</table>

---

## 🏆 Certificacions i Formació Ètica

- 📜 **Videogame Development & Virtual Reality Specialist**
- 🎓 **Open Source Advocate** - Contribucions actives a projectes FLOSS
- 🔐 **Privacy & Security First** - Formació en ciberseguretat ètica
- ♻️ **Sustainable Computing** - Green coding practices
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/axelcurros/)
[![Dev.to](https://img.shields.io/badge/dev.to-0A0A0A?style=for-the-badge&logo=dev.to&logoColor=white)](https://dev.to/axlfc)
...
<details>
<summary>📊 Veure Estadístiques</summary>
<br>
...
<p align="center">
  <i>💡 "La tecnologia ha de servir a la humanitat, no explotar-la"</i>
  <br>
  <sub>Construint un futur digital millor, un commit ètic cada vegada 🌱</sub>
  <br><br>
  <b>#SoftwareLliure #OpenSource #ÈticaTecnològica #PrivacyMatters #FLOSS</b>
</p>
